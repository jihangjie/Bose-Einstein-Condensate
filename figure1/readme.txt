BE_fig1.c: source code to generate data for figure 1

* This simulates the PDE (2.2) - (2.4) starting from a Gaussian initial profile that evolves into a finite time singularity near x = 0.
* This file depends on all functions in the folder helper/


out_pde.dat: numerical data produced by BE_fig1.c and used to plot figure 1; structured in data blocks separated by two empty lines, where the i-th data block contains the following information
...
out1_pde.dat: numerical data produced by BE_fig1.c containing the following information
