...
/*-------------------------*/
	...
	/*========================================================================*/
  	...
  	N = 10000;
	L = 10.0; // 5 for singularity at x = 0
    ...
    /*******************************************************************/ 	
 	...
 	for (i = 0; i<N+1; i++)
 	{
 	   ...
 	   U0[i] = 0.2 - (0.1-0.5*prewet_thickness)*tanh(10*(xx-0.3*L)) + (0.1-0.5*prewet_thickness)*tanh(10*(xx-0.7*L));  // dip in the middle
