BE_fig2.c: source code to generate data for figure 2

* This simulates the PDE (2.2) - (2.4) starting from a smoothed piecewise-constant initial profile with a dip in the middle that evolves into a finite time singularity near x = 0.
* This file depends on all functions in the folder helper/


out_pde.dat: numerical data produced by BE_fig2.c and used to plot figure 2 structured in data blocks separated by two empty lines, where the i-th data block contains the following information
...
out1_pde.dat: numerical data produced by BE_fig2.c and used to plot figure 2(d) containing the following information
