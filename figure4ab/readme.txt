BE_fig4ab.c: source code to generate data for figure 4(a-b)
...
* The parameters n = 2, alpha = 8, and beta = 0.5
* This file depends on all functions in the folder helper/


out_pde.dat: numerical data produced by BE_fig4ab.c and used to plot figure 4(a-b) structured in data blocks separated by two empty lines, where the i-th data block contains the following information
...
out1_pde.dat: numerical data produced by BE_fig4ab.c and used to plot figure 4(a-b) containing the following information
