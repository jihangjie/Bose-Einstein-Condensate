# Bose-Einstein Condensate PDE model

This README file provides an overview of the repository for the PDE simulation of a Bose-Einstein PDE model using centered finite differences and implicit time-stepping. In particular, the whole supplemental package contains:  
...
## Folder "figure3" 
* The solution dynamics starting from a mixture of two Gaussian-shaped humps that evolves into ridge moving toward x = 0.
...
## Folder "figure4ab" 
* The solution dynamics starting from a mixture of two Gaussian-shaped humps that evolves into ridge moving toward x = 0. The parameters n = 2, alpha = 8, and beta = 0.5
...
## Folder "figure4cd" 
* The solution dynamics starting from a mixture of two Gaussian-shaped humps that evolves into ridge moving toward x = 0. The parameters n = 4, alpha = 8, and beta = 0.5
